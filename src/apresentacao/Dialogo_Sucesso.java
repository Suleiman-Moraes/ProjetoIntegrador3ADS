...
public class Dialogo_Sucesso extends javax.swing.JInternalFrame {

    private JDesktopPane principal;
    private JInternalFrame tela = null;
    public Dialogo_Sucesso(JDesktopPane principal, String mensagem, String caminho) {
        initComponents();
    ...
    public Dialogo_Sucesso(JDesktopPane principal, String mensagem) {
        initComponents();
        this.principal = principal;
        this.jTextAreaMensagem.setText(mensagem);
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/apresentacao/imagem/sucesso.png"))); // NOI18N
    ...
    private void jButtonOKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonOKActionPerformed
        try {
            ...
            tela = new Dialogo_Sucesso(principal, e.getMessage(), this.getClass().getName());
            principal.add(tela);
            tela.setVisible(true);
            this.dispose();
        }
    ...
    public static void dialogo_Sucesso(JDesktopPane pane, String mensagem){
        try {
            Dialogo_Sucesso tela = new Dialogo_Sucesso(pane, mensagem);
            pane.add(tela);
            tela.setVisible(true);
        } catch (Exception e) {
            e.printStackTrace();
